      ...
      <section id="benefits" className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {/* <!-- Card 1 --> */}
            <div className="bg-white rounded-lg shadow-md overflow-hidden transform transition-transform hover:-translate-y-1 hover:shadow-lg">
              ...
              <div className="p-6">
                ...
                <a
                  href="#search"
                  className="text-red-400 hover:text-red-500 font-medium inline-flex items-center"
                >
                  Try our search
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="bg-gray-50 rounded-lg p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg shadow-md p-6 relative">
                <div className="absolute -top-4 left-6 w-8 h-8 bg-red-300 rounded-full flex items-center justify-center text-white font-bold">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-4 w-4"
                    viewBox="0 0 20 20"
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Renting since 2021</p>
                  </div>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-md p-6 relative">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-sm">Renting since 2022</p>
                  </div>
                </div>
                <p className="text-gray-600 italic mb-4">
          ...
          <div className="mt-16 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a
                href="#featured-properties"
                className="bg-red-300 hover:bg-red-400 text-white px-8 py-3 rounded-lg shadow-md transition-colors duration-300 font-medium"
              >
                Browse Properties
              </a>
              <a
                href="#search"
                className="bg-white hover:bg-gray-100 text-gray-700 border border-gray-300 px-8 py-3 rounded-lg shadow-md transition-colors duration-300 font-medium"
              >
                Advanced Search
              </a>
            </div>
